...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_vehicle_expenses_incurred_on'), 'vehicle_expenses', ['incurred_on'], unique=False)
    op.create_index(op.f('ix_vehicle_expenses_paid_by_id'), 'vehicle_expenses', ['paid_by_id'], unique=False)
